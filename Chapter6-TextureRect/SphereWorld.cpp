...
void DrawSongAndDance(GLfloat yRot) // Called to draw dancing objects
{
	...
	shaderManager.UseStockShader(GLT_STOCK_SHADER::GLT_SHADER_FLAT,
...
void SetupRC()
{
	...
	logoBatch.MultiTexCoord2f(0, 0.0f, static_cast<GLclampf>(height));
	logoBatch.Vertex3f(static_cast<GLfloat>(x), static_cast<GLfloat>(y), 0.0f);

	// Lower left hand corner
	logoBatch.MultiTexCoord2f(0, 0.0f, 0.0f);
	logoBatch.Vertex3f(static_cast<GLfloat>(x), static_cast<GLfloat>(y - height), 0.0f);

	// Lower right hand corner
	logoBatch.MultiTexCoord2f(0, static_cast<GLclampf>(width), 0.0f);
	logoBatch.Vertex3f(static_cast<GLfloat>(x + width), static_cast<GLfloat>(y - height), 0.0f);

	// Upper righ hand corner
	logoBatch.MultiTexCoord2f(0, static_cast<GLclampf>(width), static_cast<GLclampf>(height));
	logoBatch.Vertex3f(static_cast<GLfloat>(x + width), static_cast<GLfloat>(y), 0.0f);
...
void RenderScene(void)
{
	...
	shaderManager.UseStockShader(GLT_STOCK_SHADER::GLT_SHADER_TEXTURE_MODULATE,
