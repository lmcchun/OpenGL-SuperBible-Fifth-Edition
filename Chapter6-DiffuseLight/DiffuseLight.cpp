...
void SetupRC(void)
{
	...
	const char* szVertexProgFileName = "../Res/Chapter6-DiffuseLight/DiffuseLight.vp";
	const char* szFragmentProgFileName = "../Res/Chapter6-DiffuseLight/DiffuseLight.fp";
	diffuseLightShader = gltLoadShaderPairWithAttributes(szVertexProgFileName, szFragmentProgFileName, 2, GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_NORMAL, "vNormal");
