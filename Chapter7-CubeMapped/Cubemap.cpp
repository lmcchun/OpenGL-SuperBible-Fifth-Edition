...
#define RES_PATH "../Res/Chapter7-CubeMapped/"
...
void SetupRC()
{
	...
	reflectionShader = gltLoadShaderPairWithAttributes(RES_PATH"Reflection.vp", RES_PATH"Reflection.fp",
	...
	skyBoxShader = gltLoadShaderPairWithAttributes(RES_PATH"SkyBox.vp", RES_PATH"SkyBox.fp",
		2, GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_NORMAL, "vNormal");
